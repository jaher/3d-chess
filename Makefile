...
CXXFLAGS += $(shell $(PKG_CONFIG) --cflags gtk+-3.0 epoxy sdl2 libcurl fontconfig)
LDFLAGS  := $(shell $(PKG_CONFIG) --libs gtk+-3.0 epoxy sdl2 libcurl fontconfig) -lz -lm
...
SRCS     := main.cpp chess_types.cpp chess_rules.cpp game_state.cpp app_state.cpp \
            ...
            move_quality.cpp move_reason.cpp learner_profile.cpp \
            openings_drills.cpp \
...
OBJS     := $(SRCS:.cpp=.o)
HEADERS  := jelly.h jelly_shader.h jelly_render.h chess_types.h chess_rules.h game_state.h app_state.h board_renderer.h \
            ...
            move_quality.h move_reason.h learner_profile.h openings_drills.h
