...
// Menu screen
// ===========================================================================
// Menu-piece physics (gravity, spin, collision) lives in
// menu_physics.cpp. Everything in this section is the render/input
// side: camera ray-pick, throw impulse, draw.
